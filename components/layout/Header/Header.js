...
import { BrandName, Email, LogoImage } from '@/utils/constants'
import SendWhatsAppMessage from '../ChatOnWhatsApp/WAUtils'
...
function LogoCell() {
    return (
        <div className={styles.HeaderCell}>
            <Link href='/'><img src={LogoImage} alt={BrandName} className={styles.Logo} /></Link>
        </div>
    )
}
